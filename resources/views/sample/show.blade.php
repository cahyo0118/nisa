                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            ...
                            {!! Form::model($item, ['method' => 'delete', 'route' => ['samples.destroy', $item->id], 'id' => 'form-delete', 'class' =>'form-inline justify-content-end']) !!}
                            <a href="{{ route('samples.edit', $item->id) }}" class="btn btn-icon btn-default">
