<div class="modal fade" id="updateVariable" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addNewVariableForm" method="POST" onsubmit="">
                    {{ csrf_field() }}
                        ...
                        <div class="col-lg-9">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-alternative">
                                    ...
                                    {!! Form::text('display_name', (!empty($item) ? $item->display_name : null), ['class' => 'form-control form-control-alternative', 'placeholder' => 'Write somethings...']) !!}
                                </div>
                            </div>
                        </div>
