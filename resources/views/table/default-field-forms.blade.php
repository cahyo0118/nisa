            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="input-group input-group-alternative">
                        ...
                        {!! Form::text("name[$random]", "created_by", ["class" => "form-control form-control-alternative", "placeholder" => "", "readonly" => ""]) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="input-group input-group-alternative">
                        ...
                        {!! Form::text("display_name[$random]", "Created By", ["class" => "form-control form-control-alternative", "placeholder" => "", "readonly" => ""]) !!}
                    </div>
                </div>
            </div>
