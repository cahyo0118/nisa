...
//        permission.setCreated_by(currentUser.getId().intValue());
        permission.setUpdated_by(currentUser.getId().intValue());
        permission.setActive_flag(true);
    ...
    public ApiResponseHelper<HashMap<String, Object>> update(
        ...
        currentPermission.setUpdated_by(currentUser.getId().intValue());
        currentPermission.setActive_flag(true);
    ...
    public ApiResponseHelper<?> delete(
        ...
        permission.setActive_flag(false);
