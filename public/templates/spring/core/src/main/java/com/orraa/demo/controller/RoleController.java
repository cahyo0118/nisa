...
//        role.setCreated_by(currentUser.getId().intValue());
        role.setUpdated_by(currentUser.getId().intValue());
    ...
    public ApiResponseHelper<HashMap<String, Object>> update(
        ...
        currentRole.setUpdated_by(currentUser.getId().intValue());
        currentRole.setActive_flag(true);
